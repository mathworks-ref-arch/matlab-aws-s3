function result = int64FnHandler(obj, varargin)
    ...
    if nargin == 1
        ...
        result = sscanf(char(com.mathworks.sdk.App.invokeNamedMethodToString(obj.Handle, fnName{end})), '%ld');
    elseif nargin == 2
        % Use a named function
        result = sscanf(char(com.mathworks.sdk.App.invokeNamedMethodToString(obj.Handle, varargin{1})), '%ld');
    else
